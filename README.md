...
PeTaL is comprised of multiple interconnected services. This repository is for the ReactJS web front end client. There are other repositories for the [API](/nasa/petal-api) and [Labeller](/nasa/petal-labeller).
